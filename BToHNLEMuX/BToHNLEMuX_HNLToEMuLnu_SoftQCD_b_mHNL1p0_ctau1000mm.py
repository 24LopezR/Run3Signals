...
TripleLeptonFilter = cms.EDFilter("MCMultiParticleFilter",
    NumRequired = cms.int32(3),
    AcceptMore = cms.bool(True),
    ParticleID = cms.vint32(13,-13),
    PtMin = cms.vdouble(6.8,1.0,0.),
...
ProductionFilterSequence = cms.Sequence(generator+BFilter+TripleLeptonFilter+TriggerMuonFilter)
